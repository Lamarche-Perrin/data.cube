    ...
    fluidRow (
        column (
            ...
            titlePanel (
                ...
                windowTitle = "Multidimensional Outlier Explorer"
            ),
            fluidRow (
                column (
                    3,
                    ...
                    conditionalPanel (
                        ...
                        div (
                            img (src = "images/busy2.gif", height = 90),
                ...
                column (
                    ...
                    conditionalPanel (
                        ...
                        uiOutput ("input.selection.panel")
                    )
                ),
                column (3, uiOutput ("input.model.panel")),
                column (2, uiOutput ("input.filter.panel"), uiOutput ("input.cube.panel"))
            )
        ),
        hr ()
    ),
    ...
    conditionalPanel(
        ...
        mainPanel (
            tabsetPanel (
                ...
                tabPanel (
                    "Data structure",
                    verbatimTextOutput (outputId = "data.structure")
                )##,
                ## tabPanel (
                ##     "Data plot",
                ...
                ##             6,
                ##             downloadButton (
                ##                 outputId = "download.positive.outlier.list.csv",
                ##                 label = "Download list (csv)"
                ##             ),
                ##             downloadButton (
                ##                 outputId = "download.positive.outlier.list.json",
                ##                 label = "Download list (json)"
                ##             ),
                ...
                ##             6,
                ##             downloadButton (
                ##                 outputId = "download.negative.outlier.list.csv",
                ##                 label = "Download list (csv)"
                ##             ),
                ##             downloadButton (
                ##                 outputId = "download.negative.outlier.list.json",
                ##                 label = "Download list (json)"
                ##             ),
