...
This first example focuses on the evolution over year 2014 of the number of articles citing the 5 following countries: USA, Russia, Spain, Italy, and Japan.
...
### Taking into account the average number of articles per country

By plotting the distribution of these observations, one could define some king of "statistically expected" range of values and then identify outliers as unexpectedly high values.
...
Yet, one could also consider that each of the five selected country have its own expected range of values, depending on its "average media coverage" (average number of articles per day).
...
Hence, one could take into account these averaged values as an additional information to identify more specific outliers.
...
### Also taking into account the average number of articles per day
