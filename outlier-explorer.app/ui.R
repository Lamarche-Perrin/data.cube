    ...
    conditionalPanel(
        ...
        mainPanel (
            tabsetPanel (type="tabs",
                         ...
                         tabPanel ("Data biplot",
                                   downloadButton (outputId="download.data.biplot.pdf", label="Download plot (pdf)"),
                                   downloadButton (outputId="download.data.biplot.png", label="Download plot (png)"),
                                   plotOutput (outputId="data.biplot")),
